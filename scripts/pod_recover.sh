...
echo "→ Step 1/3: install full stack 1 lần — ~4 phút..."
# 1 lệnh duy nhất để pip resolver thấy hết constraints cùng lúc → torch
# không bị transformers/pyannote tự upgrade đè ngược.
